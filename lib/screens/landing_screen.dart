...
class LandingScreen extends StatelessWidget {
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: const [
                            _StepCard(num: '01', title: 'Pilih Folder',
                                desc: 'Pilih folder galeri\nyang mau dibersihkan',
                                icon: Icons.folder_open_rounded),
                            _StepArrow(),
                            _StepCard(num: '02', title: 'Sort Foto',
                                desc: 'Urutkan by nama,\nukuran, atau tanggal',
                                icon: Icons.sort_rounded),
                            _StepArrow(),
                            _StepCard(num: '03', title: 'Review',
                                desc: '← Hapus  →  Simpan\n↓  Undo    ↑  Skip',
                                icon: Icons.swipe_rounded),
                            _StepArrow(),
                            _StepCard(num: '04', title: 'Konfirmasi',
                                desc: 'Cek daftar hapus\nsebelum eksekusi',
                                icon: Icons.checklist_rounded),
                            _StepArrow(),
                            _StepCard(num: '05', title: 'Recycle Bin',
                                desc: 'Aman di Bin, hapus\nmanual kapanpun',
  ...
  Future<void> _pickFolder(BuildContext context, AppState state) async {
    ...
    final result = await FilePicker.platform.getDirectoryPath(dialogTitle: 'Pilih folder');
...
class _StepArrow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const Padding(
    ...
    child: Text('›', style: TextStyle(
        fontFamily: 'Courier New', fontSize: 28, color: kAmberDim)),
  );
}
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Text(num, style: const TextStyle(
            ...
            fontWeight: FontWeight.bold, color: kAmber, letterSpacing: 2)),
        ...
        Padding(
          ...
          child: Text(desc, style: const TextStyle(
              fontFamily: 'Consolas', fontSize: 12, color: kTextMuted,
              height: 1.6),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
          Text('Resume  "$folder"', style: const TextStyle(
        ...
        TextButton(
          ...
          child: const Text('Buang', style: TextStyle(
              fontFamily: 'Consolas', fontSize: 11, fontWeight: FontWeight.bold)),
        ),
        const SizedBox(width: 8),
        SweepButton(
          label: 'Lanjut →',
          bg: kAmber, hover: kAmberHov, textColor: kBg,
          height: 38, width: 100,
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: SizedBox(width: 480, height: 220, child: Column(children: [
        ...
        Text(title, style: const TextStyle(
            fontFamily: 'Courier New', fontSize: 17,
            fontWeight: FontWeight.bold, color: kText)),
        const SizedBox(height: 18),
        Text(body, style: const TextStyle(
            fontFamily: 'Consolas', fontSize: 12, color: kTextDim),
            textAlign: TextAlign.center),
        const SizedBox(height: 30),
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          SweepButton(label: confirmLabel, bg: kAmber, hover: kAmberHov,
              textColor: kBg, height: 40, width: 180, onPressed: onConfirm),
        ]),
      ])),
    );
  }
